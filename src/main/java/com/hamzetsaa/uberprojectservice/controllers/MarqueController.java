...
public class MarqueController {
	...
	if(theMarque == null) {
		...
		throw new RuntimeException( " the City is not found "+ idMarque);
	...
	public String deleteMarque( @PathVariable int idMarque) {
		...
		if (theMarque == null) {
			...
			throw new RuntimeException( " the id of ville is not found "+idMarque);
		}
		marqueService.deleteById(idMarque);
		return " the City was deleted "+idMarque;
