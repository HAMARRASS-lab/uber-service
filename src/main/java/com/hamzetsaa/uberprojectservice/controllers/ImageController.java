...
public class ImageController {
	...
	if(theImage == null) {
		...
		throw new RuntimeException( " the Image is not found "+ idImage);
	...
	public String deleteImage( @PathVariable int idImage) {
		...
		if (theImage == null) {
			...
			throw new RuntimeException( " the id of Image is not found "+idImage);
		}
		imageService.deleteById(idImage);
		return " the Image was deleted "+ idImage;
